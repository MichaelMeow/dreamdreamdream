...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            fill:["rgba(0,0,0,0)",im+"campbg.jpg",'0px','0px']
         },
         {
            id:'camppizza2',
            display:'none',
            type:'rect',
            rect:['0.5%','-2','auto','auto','auto','auto']
         },
         {
            id:'campbranch',
            display:'none',
            type:'image',
            rect:['auto','auto','352px','463px','0px','-1px'],
            fill:["rgba(0,0,0,0)",im+"campbranch.png",'0px','0px']
         },
         {
            id:'campcloud',
            display:'none',
            type:'image',
            rect:['0px','auto','517px','679px','auto','0px'],
            fill:["rgba(0,0,0,0)",im+"campcloud.png",'0px','0px']
         },
         {
            id:'campdeck2',
            display:'none',
            type:'rect',
            rect:['18.6%','auto','auto','auto','auto','-8px']
         },
         {
            id:'Text2',
            type:'text',
            rect:['67px','auto','237px','116px','auto','39px'],
            cursor:['pointer'],
            text:"BACK",
            align:"left",
            font:['cabin-sketch, sans-serif',70,"rgba(217,217,217,1.00)","normal","none","normal"],
            textShadow:["rgba(0,0,0,0.65)",7,10,12]
         }],
         symbolInstances: [
         {
            id:'camppizza2',
            symbolName:'camppizza'
         },
         {
            id:'campdeck2',
            symbolName:'campdeck'
   ...
   states: {
      "Base State": {
         ...
         "${_Text2}": [
            ...
            ["subproperty", "textShadow.offsetV", '10px'],
            ["style", "left", '67px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid874", tween: [ "style", "${_campbranch}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid880", tween: [ "style", "${_campbranch}", "display", 'none', { fromValue: 'block'}], position: 1148, duration: 0, easing: "easeInSine" },
            { id: "eid875", tween: [ "style", "${_campbg}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid881", tween: [ "style", "${_campbg}", "display", 'none', { fromValue: 'block'}], position: 1148, duration: 0, easing: "easeInSine" },
            { id: "eid871", tween: [ "style", "${_camppizza2}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid877", tween: [ "style", "${_camppizza2}", "display", 'none', { fromValue: 'block'}], position: 1148, duration: 0, easing: "easeInSine" },
            { id: "eid872", tween: [ "style", "${_campdeck2}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid878", tween: [ "style", "${_campdeck2}", "display", 'none', { fromValue: 'block'}], position: 1148, duration: 0, easing: "easeInSine" },
            { id: "eid873", tween: [ "style", "${_campcloud}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid879", tween: [ "style", "${_campcloud}", "display", 'none', { fromValue: 'block'}], position: 1148, duration: 0, easing: "easeInSine" }         ]
      }
   }
},
"work": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2559", tween: [ "style", "${_pizzaflag}", "-moz-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2560", tween: [ "style", "${_pizzaflag}", "-ms-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2561", tween: [ "style", "${_pizzaflag}", "msTransformOrigin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2562", tween: [ "style", "${_pizzaflag}", "-o-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
