...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'placebg',
            type:'image',
            rect:['0px','auto','100%','680px','auto','0px'],
            fill:["rgba(0,0,0,0)",im+"placebg.png",'50%','50%','100%','auto']
         },
         {
            id:'placesagan1',
            type:'image',
            rect:['0px','auto','400px','351px','auto','-3px'],
            fill:["rgba(0,0,0,0)",im+"placesagan1.png",'0px','0px']
         },
         {
            id:'placetextbox',
            type:'image',
            rect:['auto','48px','805px','548px','34px','auto'],
            opacity:0.89882172131148,
            fill:["rgba(0,0,0,0)",im+"placetextbox.png",'0px','0px']
         },
         {
            id:'Text',
            type:'text',
            rect:['auto','191px','195px','40px','243px','auto'],
            opacity:1,
            text:"Institute of Invention",
            font:['Arial, Helvetica, sans-serif',18,"rgba(0,0,0,1.00)","normal","none",""],
            filter:[0,0,1,1,0,0,0,0,"rgba(0,0,0,1.00)",0,0,0]
         },
         {
            id:'Text2',
            type:'text',
            rect:['auto','244px','216px','320px','238px','auto'],
            opacity:1,
            text:"Welcome to Dreamdreamdream.org, the website for the Institute of Invention.<br><br>The Institute is a special effects and design school located in NE Portland, OR.<br><br>We believe motivated play is the key to invention, and our strategy is to create and use toys for adults.  These toys are tools for play.<br><br>The Institute is inclusive and is looking for collaborators. <br><br>Contact info@dreamdreamdream.org for more information.",
            align:"left",
         ...
         },
         {
            id:'Text3',
            type:'text',
            rect:['35px','auto','126px','61px','auto','8px'],
            cursor:['pointer'],
            text:"BACK",
            align:"left",
            font:['advent-pro, sans-serif',38,"rgba(0,0,0,1.00)","normal","none","normal"],
            textShadow:["rgba(255,255,255,0.65)",3,3,3]
         }],
         symbolInstances: [
   ...
   states: {
      "Base State": {
         "${_placetextbox}": [
            ["style", "top", '48px'],
            ["style", "opacity", '0.89882172131148'],
            ["style", "height", '548px'],
            ["style", "right", '34px'],
            ["style", "left", 'auto'],
            ["style", "width", '805px']
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid2590", tween: [ "subproperty", "${_Text2}", "filter.hue-rotate", '360deg', { fromValue: '0.000000deg'}], position: 0, duration: 10000, easing: "easeInOutQuad" },
            { id: "eid2589", tween: [ "subproperty", "${_Text}", "filter.hue-rotate", '360deg', { fromValue: '0.000000deg'}], position: 0, duration: 10000, easing: "easeInOutQuad" }         ]
      }
   }
},
"work": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2619", tween: [ "style", "${_pizzaflag}", "-moz-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2620", tween: [ "style", "${_pizzaflag}", "-ms-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2621", tween: [ "style", "${_pizzaflag}", "msTransformOrigin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2622", tween: [ "style", "${_pizzaflag}", "-o-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
