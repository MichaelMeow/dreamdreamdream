...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 948, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_storeback}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kickbutton3}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
