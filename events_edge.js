...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            display:'none',
            type:'image',
            rect:['0px','0px','106.2%','100%','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"eventsbg.png",'50%','50%','100%','auto']
         },
         {
            id:'eventssand',
            display:'none',
            type:'image',
            rect:['2px','auto','100%','640px','auto','1px'],
            fill:["rgba(0,0,0,0)",im+"eventssand.png",'50%','50%','100%','auto']
         },
         {
            id:'eventsrocksleft',
            display:'none',
            type:'image',
            rect:['-2px','auto','1000px','640px','auto','-8px'],
            fill:["rgba(0,0,0,0)",im+"eventsrocksleft.png",'0px','0px']
         },
         {
            id:'eventsrocksright',
            display:'none',
            type:'image',
            rect:['auto','auto','1000px','640px','0px','0px'],
            fill:["rgba(0,0,0,0)",im+"eventsrocksright.png",'0px','0px']
         },
         {
            id:'jets',
            display:'none',
            type:'rect',
            rect:['auto','auto','auto','auto','31.9%','211px']
         },
         {
            id:'events',
            display:'none',
            type:'image',
            rect:['9.5%','68px','316px','547px','auto','auto'],
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['7px','auto','212px','221px','auto','-3px'],
            fill:["rgba(0,0,0,0)",im+"eventschair.png",'0px','0px']
         },
         {
            id:'Rectangle4',
            display:'none',
            type:'rect',
            rect:['18px','464px','175px','203px','auto','auto'],
            cursor:['pointer'],
         ...
         },
         {
            id:'Text',
            type:'text',
            rect:['15.6%','207px','191px','311px','auto','auto'],
            text:"Field day<br>June 1<br>Afternoon to late night.<br>32nd and Ainsworth<br><br>Visual Invasion<br>Electronic Music Show<br>Coming June",
         ...
         },
         {
            id:'Text2',
            type:'text',
            rect:['46px','auto','164px','57px','auto','65px'],
            cursor:['pointer'],
            text:"BACK",
            align:"left",
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid2385", tween: [ "style", "${_Rectangle4}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2386", tween: [ "style", "${_Rectangle4}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2312", tween: [ "style", "${_eventschair}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2319", tween: [ "style", "${_eventschair}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2313", tween: [ "style", "${_events}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2320", tween: [ "style", "${_events}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2439", tween: [ "style", "${_jets}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInOutQuad" },
            { id: "eid2440", tween: [ "style", "${_jets}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0, easing: "easeInOutQuad" },
            { id: "eid2374", tween: [ "style", "${_eventsbg}", "height", '116.66%', { fromValue: '116.66%'}], position: 493, duration: 0 },
            { id: "eid2375", tween: [ "style", "${_eventsbg}", "top", '-113px', { fromValue: '-113px'}], position: 493, duration: 0 },
            { id: "eid2316", tween: [ "style", "${_eventsrocksleft}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2323", tween: [ "style", "${_eventsrocksleft}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2376", tween: [ "style", "${_eventsbg}", "width", '123.94%', { fromValue: '123.94%'}], position: 493, duration: 0 },
            { id: "eid2317", tween: [ "style", "${_eventssand}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2324", tween: [ "style", "${_eventssand}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2318", tween: [ "style", "${_eventsbg}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2325", tween: [ "style", "${_eventsbg}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 },
            { id: "eid2315", tween: [ "style", "${_eventsrocksright}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2322", tween: [ "style", "${_eventsrocksright}", "display", 'none', { fromValue: 'block'}], position: 1335, duration: 0 }         ]
      }
   }
},
"work": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2599", tween: [ "style", "${_pizzaflag}", "-moz-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2600", tween: [ "style", "${_pizzaflag}", "-ms-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2601", tween: [ "style", "${_pizzaflag}", "msTransformOrigin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2602", tween: [ "style", "${_pizzaflag}", "-o-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
