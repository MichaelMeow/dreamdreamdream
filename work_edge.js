...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            display:'none',
            type:'image',
            rect:['0','-59px','100%','118.2%','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"workbg.jpg",'0px','0px']
         },
         {
            id:'book',
            display:'none',
            type:'rect',
            rect:['50.9%','0%','auto','auto','auto','auto']
         },
         {
            id:'workback2',
            display:'none',
            type:'image',
            rect:['5.4%','22.8%','239px','351px','auto','auto'],
            cursor:['pointer'],
            fill:["rgba(0,0,0,0)",im+"workback.png",'0px','0px']
         }],
         symbolInstances: [
         {
            id:'book',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid780", tween: [ "style", "${_workback2}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid783", tween: [ "style", "${_workback2}", "display", 'none', { fromValue: 'block'}], position: 1573, duration: 0, easing: "easeInSine" },
            { id: "eid781", tween: [ "style", "${_workbg2}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid784", tween: [ "style", "${_workbg2}", "display", 'none', { fromValue: 'block'}], position: 1573, duration: 0, easing: "easeInSine" },
            { id: "eid779", tween: [ "style", "${_book}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid782", tween: [ "style", "${_book}", "display", 'none', { fromValue: 'block'}], position: 1573, duration: 0, easing: "easeInSine" }         ]
      }
   }
},
"work": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2515", tween: [ "style", "${_pizzaflag}", "-moz-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2516", tween: [ "style", "${_pizzaflag}", "-ms-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2517", tween: [ "style", "${_pizzaflag}", "msTransformOrigin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2518", tween: [ "style", "${_pizzaflag}", "-o-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
