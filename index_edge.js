...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'birds3',
            type:'rect',
            rect:['auto','-130px','auto','auto','110px','auto']
         },
         {
            id:'homegroup',
            type:'group',
            rect:['-19.9%','auto','1360','680','auto','0%'],
            c:[
            {
               id:'Clouds',
               type:'rect',
            ...
            },
            {
               id:'eventsbutton',
               type:'rect',
               rect:['357px','559px','278px','131px','auto','auto'],
               cursor:['pointer'],
               fill:["rgba(192,192,192,1)"],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid2764", tween: [ "style", "${_kickbutton}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2070", tween: [ "style", "${_kickbutton}", "display", 'none', { fromValue: 'none'}], position: 1102, duration: 0, easing: "easeInOutSine" },
            { id: "eid2015", tween: [ "style", "${_birds3}", "top", '31px', { fromValue: '31px'}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid695", tween: [ "style", "${_birds3}", "display", 'none', { fromValue: 'block'}], position: 11174, duration: 0, easing: "easeInSine" },
            { id: "eid2016", tween: [ "style", "${_birds3}", "right", '285px', { fromValue: '285px'}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2763", tween: [ "style", "${_picklereveal}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid2069", tween: [ "style", "${_picklereveal}", "display", 'none', { fromValue: 'none'}], position: 1063, duration: 0, easing: "easeInOutSine" },
            { id: "eid965", tween: [ "style", "${_sky2}", "display", 'none', { fromValue: 'block'}], position: 11484, duration: 0, easing: "easeInSine" },
            { id: "eid253", tween: [ "style", "${_homegroup}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0, easing: "easeInSine" },
            { id: "eid249", tween: [ "style", "${_homegroup}", "display", 'none', { fromValue: 'block'}], position: 11721, duration: 0, easing: "easeInSine" }         ]
      }
   }
},
"work": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2789", tween: [ "style", "${_pizzaflag}", "-moz-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2790", tween: [ "style", "${_pizzaflag}", "-ms-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2791", tween: [ "style", "${_pizzaflag}", "msTransformOrigin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
            { id: "eid2792", tween: [ "style", "${_pizzaflag}", "-o-transform-origin", [57.81,24.12], { valueTemplate: '@@0@@% @@1@@%', fromValue: [57.81,24.12]}], position: 0, duration: 0, easing: "easeInOutSine" },
